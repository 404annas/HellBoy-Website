    ...
    >
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="flex flex-col items-center mb-16">
          ...
          >
            <div className="w-48 h-32 rounded-lg flex items-center justify-center relative overflow-visible group">
              <div
                className="w-full h-full bg-cover bg-center rounded-lg transition-all duration-500 group-hover:scale-105"
                style={{
              ...
              <div
                className={`absolute -top-8 -right-5 bg-gray-200 text-black px-3 py-1 rounded-full text-sm font-bold z-10 transition-all duration-500 ${
                  speechBubbleVisible
                    ? "translate-y-0 opacity-100 scale-100"
                    : "-translate-y-2 opacity-0 scale-95"
                } hover:bg-gray-100 hover:scale-110 cursor-default`}
              >
                <span className="relative z-10">Indispensable</span>
                <div className="absolute bottom-0 left-4 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-200 transform translate-y-full"></div>
              ...
              <div
                className="absolute -top-2 -left-2 text-blue-400/70 animate-bounce"
                style={{ animationDelay: "0s" }}
              >
                <FaMusic className="w-4 h-4 fill-current" />
              </div>
              <div
                className="absolute -bottom-2 -right-2 text-blue-300/50 animate-bounce"
                style={{ animationDelay: "1s" }}
              >
                <FaMusic className="w-3 h-3 fill-current" />
              </div>
            </div>
          </div>
          ...
          {/* Logo Section */}
          <div
            className={`text-center transition-all duration-1200 delay-600 ${
              isVisible
                ? "translate-y-0 opacity-100"
                : "translate-y-6 opacity-0"
            }`}
          >
            <div className="text-sm tracking-wider text-gray-400 mb-2 hover:text-gray-300 transition-colors duration-300">
              Video Producer
            </div>
            <div className="mb-4 group cursor-default">
              <h1 className="text-6xl font-bold text-transparent bg-gradient-to-b from-red-500 via-red-600 to-yellow-600 bg-clip-text hover:scale-105 transition-transform duration-300">
                FEPO
              </h1>
              {/* Glow effect */}
              <div className="absolute inset-0 text-6xl font-bold text-red-500/10 blur-sm group-hover:text-red-500/20 transition-all duration-300">
                FEPO
              </div>
            </div>
            <div className="text-xl tracking-[0.3em] text-white font-semibold hover:text-gray-300 transition-colors duration-300">
              Shahrukh Kazim
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="text-sm text-gray-400 mb-6 lg:mb-0 lg:max-w-md">
            <p className="mb-2 hover:text-gray-300 transition-colors duration-300">
              Shahrukh Kazim AKA Fepo® The top guy featured in several national
        ...
        <div className="container mx-auto px-4 py-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center space-x-6 mb-4 lg:mb-0">
              ...
              >
                WEBSITE Powered by &nbsp;<a href="https://techxudo.com" target="_blank">{" "}Techxudo</a>
          ...
          >
            COPYRIGHT 2025, Powered by Techxudo
          </div>
        </div>
